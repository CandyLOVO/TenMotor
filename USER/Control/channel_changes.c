...
extern pidTypeDef PID_speed_6020_2[4];
...
int16_t get_6020_2[4];
int16_t speed_6020_2[4];
int16_t output_6020_2[4];
...
void translational_control() //Chassis translational control
{
	...
	for(int i=0;i<4;i++){
		speed_6020_2[i] = pid_cal_s(&PID_speed_6020_2[i],motor[i+4].speed,20,Max_out_s,Max_iout_s); 
	}
	can_cmd_send_6020_2(speed_6020_2[0],speed_6020_2[1],speed_6020_2[2],speed_6020_2[3]);
